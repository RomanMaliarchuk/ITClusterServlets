...
import ua.com.maliarchuk.controller.Controller;
...
/**
 * Created by roman on 15.07.2017.
 */
import javax.servlet.ServletException;
import javax.servlet.annotation.WebServlet;
import javax.servlet.http.HttpServlet;
    ...
    protected void doPost(HttpServletRequest request,
        ...
        try {
            out.println("<!DOCTYPE html>\n" +
                    ...
                    "    <form action=\"inputUserData\" method=\"POST\">\n" +
                    "        <h2>Додати нового користувача</h2>\n" +
                    "        <label>\n" +
                    "            <h2>Логін:</h2>\n" +
                    "            <input name=\"userName\" type=\"text\" size=\"15\" maxlength=\"14\">\n" +
                    "        </label>\n" +
                    "        <label>\n" +
                    "            <h2>Пароль:</h2>\n" +
                    "            <input name=\"password\" type=\"password\" size=\"15\" maxlength=\"14\">\n" +
                    "        </label>\n" +
                    "        <input name=\"sendData\" type=\"submit\" value=\"Ввести\">\n" +
                    "        <input name=\"action\" type=\"hidden\"  value=\"inputDataUser\">\n" +
                    "    </form>\n" +
                    "</div>\n" +
                    "\n" +
                    "</body>\n" +
